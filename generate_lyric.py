    ...
    with torch.no_grad():
        while True:
            ...
            if mpu.get_model_parallel_rank() == 0:
                ...
                decode_tokens_1 = tokenizer.decode(output_tokens_list[output_context_length:args.seq_length]).replace("<eod>", "\n")
                decode_tokens_2 = tokenizer.decode(output_tokens_list[args.seq_length:]).replace("<eod>", "\n")
                print("\nCPM:",
